...
namespace Harjoitus8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Työntekijä Työntekijä1 = new Työntekijä("Kalle Tiihola", "TuhoonTuomitunKuja 56 C 20, Vantaa 1600", "Careeria Oy", 37.5M, 1);
            Työntekijä Työntekijä2 = new Työntekijä("Jesse Pelkonen", "Keskellä Ei Mitään Tie 66 D 6, Vantaa 1300", "Tikkurila Oy", 30.2M, 5);
            Pomo Pomo1 = new Pomo("Tero Kaikentietävä", "LuksusKuja 13 E 37, Espoo 0420", "SuperCell", 40M, 9);
            Työntekijä1.PalkkaTaulukko();
